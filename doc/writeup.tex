...
If we can choose a scalar test statistic, we can produce a p value of realized statistic versus model theoretic probably of the statistic being more extreme than that. Not an obvious candidate unless we can use some sort of loss function?
...
We look at the distribution of realized loss functions with k-fold cross validation. And compare the Advanced data under each of our proposal models, and benchmark this against the results of the generated data.
...
We will compare the performance of our decision rules versus common MAB algorithms.
